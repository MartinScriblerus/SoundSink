...
export default function Streamgraph({ width, height, meydaData, animate = true }: StreamGraphProps) {
  const forceUpdate = useForceUpdate();
  const handlePress = () => forceUpdate();
    console.log("PLADOW: ", meydaData.map((i:any) => i))
  ...
  console.log("steamkeys: ", keys);
  console.log("steamdata: ", layers);
  console.log("samp per layer ", SAMPLES_PER_LAYER);
  console.log("bumps per layer ", BUMPS_PER_LAYER);
