...
const MingusPopup = ({
    ...
    }, [isChordSelectOpen, isKeySelectOpen, isScaleSelectOpen, isOctaveMaxSelectOpen, isOctaveMinSelectOpen]);
    ...
    return (
        ...
        >
            ...
            >
                {noteBuilderFocus && noteBuilderFocus && !noteBuilderFocus.toLowerCase().includes("micro") && <FormControl sx={{
                    // width: '60px', 
                    width: 'fit-content',
                    color: 'rgba(245,245,245,0.78)',
                    position: 'relative',
