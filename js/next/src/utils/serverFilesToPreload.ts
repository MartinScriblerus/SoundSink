const serverFilesToPreload = [
    ...
    {
      serverFilename: '/moogGMSynthVoice.ck',
      virtualFilename: 'moogGMSynthVoice.ck'
    },
    {
      serverFilename: '/useMoogGM.ck',
      virtualFilename: 'useMoogGM.ck'
    },
    {
      serverFilename: '/initializeChuck.ck',
      virtualFilename: 'initializeChuck.ck'
    },
    {
    ...
    {
      serverFilename: "/elliptic-help.ck",
    ...
    {
      serverFilename: "/expdelay-help.ck",
    ...
    {
      serverFilename: "/multicomb-help.ck",
    ...
    {
      serverFilename: "/autotune-test.ck",
      virtualFilename: "autotune-test.ck"
    },
    {
      serverFilename: "/pitchtrack-help.ck",
    ...
    {
      serverFilename: "/poweradsr-feedback-beatings.ck",
      virtualFilename: "poweradsr-feedback-beatings.ck"
    },
    {
      serverFilename: "/poweradsr-help.ck",
    ...
    {
      serverFilename: "/spectacle-help.ck",
    ...
    {
      serverFilename: "/sigmund-tracks-test.ck",
    ...
    {
      serverFilename: "/winfuncenv-help.ck",
    ...
    {
      serverFilename: "/WPDiodeLadder-test.ck",
